...
class AppStore extends Component {
  ...
  updateStateOnTabChange = id => {
    this.setState({
      category: appsList.filter(eachApp => eachApp.category === id)[0].category,
    })
  }
        ...
        <ul className="tabs-container">
          {tabsList.map(eachTab => (
            <TabItem
              ...
              updateStateOnTabChange={this.updateStateOnTabChange}
            />
          ))}
        </ul>
